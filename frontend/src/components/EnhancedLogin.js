...
const EnhancedLogin = () => {
  ...
  const handleRoleSelect = (role) => {
    ...
    setStep(twoFactorRequired ? '2fa' : 'login-form');
    clearAuthError();
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 mt-8 border border-white/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="text-white/90 bg-white/10 rounded-lg p-3 flex items-center">
                ...
                <span><strong>2FA Support</strong><br/>Two-factor authentication</span>
              </div>
              <div className="text-white/90 bg-white/10 rounded-lg p-3 flex items-center">
                <Clock className="w-4 h-4 mr-2" />
                <span><strong>Auto Refresh</strong><br/>Seamless sessions</span>
              </div>
              <div className="text-white/90 bg-white/10 rounded-lg p-3 flex items-center">
                <CheckCircle className="w-4 h-4 mr-2" />
                <span><strong>Multi-Role</strong><br/>Role switching</span>
              </div>
            </div>
          </div>
